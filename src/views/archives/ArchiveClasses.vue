<template>
    <div id="ClassesPage" v-if="this.currentPromoScolaire">
        <div class="pagetitle">
            <h1>Nos élèves</h1>

            <div class="">
                <form class="search-form d-flex align-items-center">
                    <input type="text" v-model="searchExpression"
                        placeholder="Rechercher un élève par nom, prénom ou classe" @input="filterStudents">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    <tr class="classe" v-for="eleve in filteredStudents" :key="eleve.mat"
                                        @click="goToEleveInfos(eleve)">
...
export default {
    ...
    methods: {
        ...
        filterStudents() {
            ...
            for (const classe of this.currentPromoScolaire.promotions) {
        ...
        goToEleveInfos(eleve) {
            ...
            const url = `/archives-eleve/${classId}`;
